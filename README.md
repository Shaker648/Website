...
كل الباقي حقيقي ومتأكد منه: واتساب `01117550080`، إيميل `admin@first1car.net`،
٦ فروع، ١١ خط مبيعات، ٩ ماركات، ٣٨ موديل، ٩٤ فئة، ١٤ بنك، السجل الضريبي، المواعيد.
...
لو عندك صورة لموديل معيّن، ضيف حقل `photo` جنبه في `data.js`:
