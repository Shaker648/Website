...
**٣٧ طرازاً من ٣٨ لديها صور حقيقية.** الطراز الوحيد الباقي (تيجو ٧ برو CKD)
يعرض رسمة حسب نوع السيارة لحين توفّر صورته.
...
**كل الخانات السبعة متملّية بالفعل.** كل خانة بتقبل **ملف محلي** أو
**لينك https:// كامل**. سيبها `""` وهيرجع التصميم البديل. لو الصورة مش موجودة أو اللينك بايظ، بترجع للتصميم البديل
